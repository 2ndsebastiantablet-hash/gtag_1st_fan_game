(function () {
  ...
  function buildGrass(root) {
    entity(root, "a-entity", {
      id: "reactive-grass",
      "reactive-grass-field": "count: 10500; size: " + MAP_SIZE + "; seed: " + SEED + "; color: " + C.grassLight + "; heightMin: 0.7; heightMax: 2.35"
    });

    entity(root, "a-entity", {
      id: "reactive-tall-grass",
      "reactive-grass-field": "count: 4800; size: " + MAP_SIZE + "; seed: " + (SEED + 73) + "; color: " + C.grass + "; heightMin: 1.45; heightMax: 3.25"
    });
  }
